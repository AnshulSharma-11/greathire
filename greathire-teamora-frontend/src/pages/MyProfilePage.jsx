...
const ICON_BY_NAME = { Percent: Gauge, Clock: Clock3, CalendarCheck2: CalendarCheck, CalendarX2: FileBarChart2 };
...
export default function MyProfilePage() {
  ...
  const { profile, statCards, documents, personalInfo } = bundle;
  const contact = personalInfo.find((p) => p.label === "Contact");
