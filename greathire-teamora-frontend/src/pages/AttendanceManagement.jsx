  ...
  return (
    <aside className="static inset-y-0 left-0 z-50 w-64 h-full bg-slate-900 text-slate-300 flex flex-col justify-between flex-shrink-0">
      ...
      <div className="px-3 pb-6">
        <button className="w-full flex items-center justify-center gap-2 border border-slate-700 text-slate-300 hover:bg-slate-800/60 transition-colors text-sm font-medium py-2.5 rounded-lg mb-4">
...
function PageHeader({ onExport, onExportCsv, onRefresh }) {
  return (
    <div className="flex flex-col xl:flex-row xl:items-start xl:justify-between gap-4 mb-6">
      ...
      <div className="flex flex-wrap items-center gap-2">
        <button onClick={onExport} className="flex items-center gap-2 bg-white border border-slate-200 rounded-lg px-3 py-2 text-sm font-medium text-slate-700 hover:bg-slate-50">
          <Download className="w-4 h-4" />
          Export
        </button>
        <button onClick={onExportCsv} className="flex items-center gap-2 bg-white border border-slate-200 rounded-lg px-3 py-2 text-sm font-medium text-slate-700 hover:bg-slate-50">
...
function Filters({ date, onDateChange, department, onDepartmentChange, departments, status, onStatusChange }) {
  ...
  return (
    <div className="flex flex-wrap items-center gap-3 mb-6">
      <label className="flex items-center gap-2 bg-white border border-slate-200 rounded-lg px-3 py-2 text-sm font-medium text-slate-700">
...
function LiveAttendanceRow({ row }) {
  return (
    <tr className="border-t border-slate-100">
      ...
      <td className="py-3 pr-4 text-sm text-slate-600 whitespace-nowrap">{row.hours}</td>
  ...
  return (
    <div className="bg-white rounded-xl border border-slate-200 p-5">
      <div className="flex items-center justify-between mb-4">
        <h3 className="text-base font-semibold text-slate-900">Live Attendance</h3>
...
function ActivityPanel({ summary }) {
  return (
    <div className="bg-white rounded-xl border border-slate-200 p-5">
      <h3 className="text-base font-semibold text-slate-900 mb-4">Today's Summary</h3>
    ...
    <div className="w-screen h-screen overflow-hidden flex bg-slate-50">
      ...
      <div className="flex-1 flex flex-col min-w-0 h-full">
        ...
        <main className="flex-1 overflow-y-auto px-4 sm:px-6 py-6">
          <PageHeader onExport={handleExport} onExportCsv={handleExport} onRefresh={refresh} />
          <Filters
            date={date}
