...
export const sidebarNav = [
  { id: "dashboard", label: "Dashboard", icon: "LayoutGrid", href: "/employee-dashboard" },
  { id: "attendance", label: "Attendance", icon: "CalendarDays", href: "/employee-dashboard" },
  { id: "leave", label: "Leave", icon: "CalendarClock", href: "/employee-dashboard" },
