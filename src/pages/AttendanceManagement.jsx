...
let navItems = [
  ...
  { label: "Attendance", icon: CalendarCheck, active: true },
  ...
  return (
    <aside className="static inset-y-0 left-0 z-50 w-64 h-full bg-slate-900 text-slate-300 flex flex-col justify-between flex-shrink-0">
      ...
      <div className="px-3 pb-6">
        <button className="w-full flex items-center justify-center gap-2 border border-slate-700 text-slate-300 hover:bg-slate-800/60 transition-colors text-sm font-medium
        ...
        <div className="border-t border-slate-800 pt-3 flex flex-col gap-1">
          <button className="flex items-center gap-3 px-3 py-2.5 rounded-lg text-sm font-medium text-slate-400 hover:bg-slate-800/60 hover:text-white transition-colors 
                              text-left">
  ...
  return (
    <div className="flex flex-col xl:flex-row xl:items-start xl:justify-between gap-4 mb-6">
      ...
      <div className="flex flex-wrap items-center gap-2">
        ...
        <button className="flex items-center gap-2 bg-blue-50 border border-blue-100 rounded-lg px-3 py-2 text-sm font-medium text-blue-600 hover:bg-blue-100">
        ...
        <table className="w-full min-w-[560px]">
          ...
          <tbody>
            {liveAttendance.map((row) => (
              <LiveAttendanceRow key={row.name} row={row} />
            ))}
          </tbody>
        </table>
      </div>
